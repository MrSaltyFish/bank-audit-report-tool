...
function SignupPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const response = await fetch("".concat(("TURBOPACK compile-time value", "http://localhost:3000"), "/api/auth/register"), {
                method: "POST",
                headers: {
            ...
            const text = (_ref = (_data_error = data === null || data === void 0 ? void 0 : data.error) !== null && _data_error !== void 0 ? _data_error : data) !== null && _ref !== void 0 ? _ref : "Unknown error";
    ...
    var _message_type;
    const alertStyle = (_message_type = ({
        success: "bg-green-100 text-green-700",
        warning: "bg-yellow-100 text-yellow-800",
        error: "bg-red-100 text-red-700"
    })[message.type]) !== null && _message_type !== void 0 ? _message_type : "";
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                        ...
                        children: [
                            ...
                            message.text && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "text-sm rounded px-3 py-2 ".concat(alertStyle),
...
_s(SignupPage, "31FzRENFUWZhVDOF9H1lGvA54B8=", false, function() {
    return [
